...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    const { employeeId, employeeEmail, employeeName, requestedMemberIds }: EmployeeSummaryData = await req.json();
    
    console.log("Sending employee DBS summary to:", employeeEmail);
    ...
    console.log("Employee summary email sent successfully:", emailData);
    ...
    console.error("Error in send-employee-dbs-summary:", error);
    return new Response(
